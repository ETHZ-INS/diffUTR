...
Of note, however, in most settings the accuracy of `diffSplice2` is still inferior to that of `r BiocStyle::Biocpkg("DEXSeq")`, which therefore remains the method of choice for DEU. However, as the computationally-heavy `r BiocStyle::Biocpkg("DEXSeq")` does not scale well and is not applicable in all situations, we recommend `diffSplice2` as the next best method.
